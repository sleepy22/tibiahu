...
/**
 * Base class that represents a row from the 'tibia_setting' table.
 *
 * 
 *
...
abstract class BaseSetting extends BaseObject  implements Persistent {
  ...
  const PEER = 'SettingPeer';
	...
	public function setKey($v)
	{
		...
		if ($this->key !== $v) {
			$this->key = $v;
			$this->modifiedColumns[] = SettingPeer::KEY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = SettingPeer::NUM_COLUMNS - SettingPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SettingPeer::KEY)) $criteria->add(SettingPeer::KEY, $this->key);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SettingPeer::KEY, $this->key);
