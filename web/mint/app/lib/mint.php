...
class Mint
{
	...
	function _tidyDB() 
	{
		$this->logError('The _tidyDB() method has been eliminated in favor of the new _tidySave() method. Please report sighting this message on the <a href="http://anonym.to/?http://www.haveamint.com/forum/">Mint Forum</a>.');
	}
	...
	function update() 
	{
		...
		if (empty($this->cfg['activationKey']) || ($this->cfg['version'] < 200 && $this->cfg['version'] != 119))
		{
			...
			if (isset($_POST['activationKey']))
			{
				...
				{
					$this->cfg['activationKey'] = 'Mint217';
				}
				else
				{
					global $Mint;
