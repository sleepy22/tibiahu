...
class Pepper
{
	...
	function Pepper($pepperId)
	{
		...
		if ($this->Mint->version < 200)
		{
			...
			$this->Mint->logErrorNote('<p>Mint has detected the unlicensed use of the Mint 2 Pepper class on a '.$this->Mint->getFormattedVersion().' installation. Mint 2 is a paid upgrade. Please login into the <a href="http://anonym.to/?http://www.haveamint.com/account/">Mint Account Center</a> and upgrade the license for this domain.</p>');
