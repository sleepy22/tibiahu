  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			sfGuardUserPeer::doOnDeleteSetNull($criteria, $con);
			...
			// invalidate objects in NewsPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$selectCriteria->add(NewsPeer::USER_ID, $obj->getId());
			$updateValues->add(NewsPeer::USER_ID, null);
